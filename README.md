...
# Travis+pytest find_substrings
 ...
 The Travis build config in ```.travis.yml``` runs pytest to execute tests found in ```./tests``` against the substring module provided in the find_substrings package in ```./src/find_substrings```
